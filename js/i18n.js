...
const TRANSLATIONS = {
    es: {
        ...
        itin: {
            ...
            enrichUnavailable: 'Las recomendaciones locales no estan disponibles ahora. La ruta, los dias, las distancias y los costes de abajo estan calculados y son completos.',
    ...
    en: {
        ...
        itin: {
            ...
            enrichUnavailable: 'Local recommendations are not available right now. The route, days, distances and costs below are computed and complete.',
    ...
    ca: {
        ...
        itin: {
            ...
            enrichUnavailable: 'Les recomanacions locals no estan disponibles ara. La ruta, els dies, les distancies i els costos de sota estan calculats i son complets.',
    ...
    fr: {
        ...
        itin: {
            ...
            enrichUnavailable: 'Les recommandations locales ne sont pas disponibles pour le moment. L\'itineraire, les jours, les distances et les couts ci-dessous sont calcules et complets.',
    ...
    zh: {
        ...
        itin: {
            ...
            enrichUnavailable: '当地推荐暂时不可用。下方的路线、天数、距离和费用均已计算完成且完整。',
